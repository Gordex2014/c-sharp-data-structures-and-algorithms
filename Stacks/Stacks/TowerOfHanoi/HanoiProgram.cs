...
namespace HanoiTowers
{
    static class HanoiProgram
    {
        ...
        public static void Exec()
        {
            ...
            var discsStr = Console.ReadLine();
            Console.WriteLine("");
            Console.WriteLine($"Tower of Hanoi example with {discsStr} discs");
            Console.WriteLine("");
            int discs = Convert.ToInt32(discsStr);
            _columnSize = Math.Max(6, GetDiscWidth(discs) + 2);
            HanoiTower algorithm = new HanoiTower(discs);
